...
const interests = [
  {
    ...
    description: "Quand vous travaillez sur quelque chose d'important"
  },
  {
    id: 2,
    code: "PT",
    ...
    description: "Face à un problème concret"
  },
  {
    id: 3,
    code: "AL",
    ...
    description: "Quand un problème se présente"
  },
  {
    id: 4,
    code: "SI",
    ...
    description: "Face à l'inconnu ou à un défi technique"
  },
  {
    id: 5,
    code: "CS",
    ...
    description: "Avant de passer à l'action"
  },
  {
    id: 6,
    code: "EC",
    ...
    description: "Dans vos productions (travaux, projets, créations)"
  },
  {
    id: 7,
    code: "MP",
    ...
    description: "Dans votre quotidien"
  },
  {
    id: 8,
    code: "CP",
    ...
    description: "Dans une dynamique de groupe"
  },
  {
    id: 9,
    code: "IP",
    ...
    description: "Face à une situation établie"
  },
  {
    id: 10,
    code: "AT",
    name: "Action & efficacité terrain",
    title: "Action & efficacité terrain",
    description: "Au travail, vous préférez"
  },
  {
    id: 11,
    code: "AA",
    ...
    description: "Dans vos interactions avec les autres"
  },
  {
    id: 12,
    code: "RI",
    ...
    description: "Dans vos échanges avec les autres"
  }
];
